...
//
//  @Bean
//  public KafkaConsumer<KeyTopic, ValueTopicRegisteredUser> kafkaConsumer() {
//    Deserializer<KeyTopic> keyDeserializer = new KeyTopicDeserializer();
//    ObjectMapper objectMapper =
//        new ObjectMapper()
//            .registerModule(new com.fasterxml.jackson.datatype.jsr310.JavaTimeModule());
//    Deserializer<ValueTopicRegisteredUser> valueDeserializer =
//        new JsonDeserializer<>(ValueTopicRegisteredUser.class, objectMapper);
//
